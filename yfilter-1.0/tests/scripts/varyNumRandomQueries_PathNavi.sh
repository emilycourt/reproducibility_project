...
RESULT_DIR="varyNumRandomQueries_PathNavi"
...
${JAVA} edu.berkeley.cs.db.yfilter.filter.EXfilter ${XML_DOCS} ${QUERY_FILE} --num_docs=${NUM_DOCS} --num_queries=${QNUMBER} --result=NONE --nfa_opt=0
