...
QUERY_FILE=${TEST_DIR}/queries-153928-d.txt

### prepare the work directory
cd ${TEST_DIR}

RESULT_DIR="varyNumDistinctQueries"
...
for QNUMBER in 0 1000 25000 50000 75000 100000 125000 150000  ; do 
#for QNUMBER in 1000 2000 ; do
